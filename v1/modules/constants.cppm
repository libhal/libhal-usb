...
export module hal.usb:constants;
...
// Assigned by USB-IF
export enum class class_code : hal::byte {
...
export enum class transfer_type : hal::byte {
  control = 0x00,
  isochronous = 0x01,
  bulk = 0x02,
  interrupt = 0x03,
...
// Default types
export enum class descriptor_type : hal::byte {
  device = 0x1,
  configuration = 0x2,
  string = 0x3,
  interface = 0x4,
